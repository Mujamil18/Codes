/*you have a grid of given size - rows and columns [r anc c]. You have to fill the grid with 0
 A ball will be placed at the bottom of the grid[r-1th row] at the given column i(0 index).
  You have to mark the ball's position in the grid as 1.*/
package practice;
...
public class BallPosition
{
    public static void main (String[] args)
    {
        ...
        do {
            ...
            {
                case 1:
                    System.out.print("Enter the ball's position: ");
                    pos= sc.nextInt();
